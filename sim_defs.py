...
Slung_LQR_P2P = {
    ...
    'PAYLOAD_DEFS':{
        'p1':{
            'position':[-1,0,2],'orientation':[0,0,0],'x': 0.4,'y': 0.4,'z': 0.2,'mass': 1.0,
...
Slung_PID_P2P = {
    ...
    'CONTROLLER_DEFS':{
        'q1':{
            ...
            'Goals':[
                {'time': 0,  'position': ( 1, 1,2), 'yaw': 0},
                {'time': 8,  'position': ( 1,-1,4), 'yaw': 0},
                {'time': 16, 'position': (-1,-1,2), 'yaw': 0},
                {'time': 24, 'position': (-1, 1,4), 'yaw': 0}
                ],
            'Linear_PID':{'P':[1,1,3],'I':[0.01,0.01,0.3],'D':[1.8,1.8,1.2]},
            'Angular_PID':{'P':[15,15,8],'I':[0.01,0.01,0.01],'D':[2,2,15]},
            },
        },
    'CABLE_DEFS':{
        'c1':{'quad':'q1','load':'p1','hardpoint': 0,'stiffness': 100,'damping': 1},
...
Multi_PID_P2P = {
    ...
    'CONTROLLER_DEFS':{
        'q1':{
            ...
            'Angular_PID':{'P':[35,35,8],'I':[0.01,0.01,0.01],'D':[10,10,20]},
            }, 
        'q2':{
            'Type':'pid_p2p',
            'Goals':[
...
Both_P2P = {
    ...
    'CONTROLLER_DEFS':{
        ...
        'q2':{
            ...
            'Linear_PID':{'P':[1,1,3],'I':[0.01,0.01,0.1],'D':[1.8,1.8,1.2]},
            'Angular_PID':{'P':[15,15,8],'I':[0.01,0.01,0.01],'D':[2,2,15]},
            'offset_gravity': 1, # Fraction of quad weight
            },
        },
